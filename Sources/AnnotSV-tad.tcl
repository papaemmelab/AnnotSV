...
proc TADannotation {SVchrom SVstart SVend} {
	...
	foreach SVtoAnn [array names L_experiments] {
	    ...
	    set tadText($SVtoAnn) "[join [lrange [lsort -unique $L_TADcoordinates($SVtoAnn)] 0 20] ";"]\t[join [lrange [lsort -unique $L_experiments($SVtoAnn)] 0 20] ":"]"
	}
