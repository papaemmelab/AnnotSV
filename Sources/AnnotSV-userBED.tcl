...
# Check the Users BED regions annotations files (from $ANNOTSV/Annotations/Users/GRCh*/*ncludedIn*/*.bed)
# Create : $ANNOTSV/Annotations/Users/GRCh*/*ncludedIn*/*.formatted.sorted
...
proc userBEDannotation {formattedSortedUserBEDfile SVchrom SVstart SVend} {
	...
	while {![eof $f]} {
	    ...
	    # we keep only users regions with > 70% (default) overlap with the SV to annotate
		...
		## AND keeping user regions overlapping an insertion
		if {$SVtoAnn_length<=1} {
